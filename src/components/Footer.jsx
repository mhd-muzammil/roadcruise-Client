...
export default function Footer() {
  return (
    <footer id="contact" className="bg-zinc-950 border-t border-white/5 py-16 text-xs text-zinc-400">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <p className="leading-relaxed text-zinc-500 font-light pr-4">
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-bold font-serif text-white tracking-wide">Explore</h4>
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-bold font-serif text-white tracking-wide">Company</h4>
          <ul className="space-y-2">
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-bold font-serif text-white tracking-wide">Get in Touch</h4>
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-2.5 leading-relaxed text-zinc-500">
      ...
      {/* Bottom Credits */}
      <div className="max-w-7xl mx-auto px-6 border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between text-zinc-600 gap-4">
